...
==============
  ...
  * 2024 [with I. Urrestarazu-Porta & A. García-Covelo] “Sudurkaritasun fonologikoa Larrainen: /h̃/ bai, baina bokalik ez” [Phonological nasality in Larraine Basque: there is /h̃/, but no nasal vowels]. Fontes Linguae Vasconum 137, 163-190. {{% staticref "https://doi.org/10.35462/flv137.7" "newtab" %}}<i class = "ai ai-doi ai-lg"></i>{{% /staticref %}}{{% staticref "https://www.culturanavarra.es/uploads/files/FLV137-07.pdf" "newtab" %}}<i class = "ai ai-open-access ai-lg"></i>{{% /staticref %}}
